...
const AdminTemplatesPage = () => {
  ...
  const [previewSlots, setPreviewSlots] = useState([]); // Предпросмотр слотов
  const [showPreviewModal, setShowPreviewModal] = useState(false); // Модалка предпросмотра
...
const formatTime = (iso) => {
  ...
  <div className="modal-overlay">
    <div className="modal-container">
      <label className="modal-label">Ви точно хочете продовжити розклад на тиждень?</label>
  ...
  <div className="modal-overlay">
    <div className="modal-box">
      <p>Ви точно хочете видалити шаблон?</p>
